...
export default function ProductDetail() {
  const { id } = useParams()
  const { lang, t, fmt, addToCart, comments, addComment } = useApp()
  ...
  const avgRating = revs.length
    ? Math.round(revs.reduce((s, r) => s + r.rating, 0) / revs.length)
    : 0

  const handleSubmitReview = () => {
    if (!reviewName.trim() || !reviewText.trim()) return
    addComment(product.id, { name: reviewName, text: reviewText, rating: selRating })
      ...
      <div className="container">
        ...
        <div className="detail-layout">
          ...
          <div className="detail-img-wrap">
            ...
            {!product.stock && (
              <div className="detail-out-overlay">
                {t('out_stock')}
              </div>
            )}
          </div>
          ...
          <div className="detail-info">
            ...
            <div className="detail-rating">
              ...
              <span className="rating-count">
                ({revs.length} {lang === 'ar' ? 'تقييم' : 'reviews'})
              </span>
            </div>
            ...
            <div className="detail-meta">
              ...
              <div className="meta-item">
                <span className="meta-icon">📦</span>
                <span>{lang === 'ar' ? 'توصيل 2-4 أيام' : '2-4 day delivery'}</span>
              </div>
              <div className="meta-item">
                <span className="meta-icon">↩</span>
          ...
          <div className="related-section">
            ...
            <div className="products-grid">
              {related.map(p => {
                ...
                return (
                  <div key={p.id} className="product-card card" onClick={() => { navigate(`/product/${p.id}`); window.scrollTo(0,0); }}>
