...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    ...
    const unsubComments = onSnapshot(collection(db, "comments"), (snap) => {
      ...
      snap.docs.forEach((d) => {
        const data = d.data();
        if (!map[data.productId]) map[data.productId] = [];
        map[data.productId].push({ id: d.id, ...data });
      });
      setComments(map);
    });
  ...
  const addComment = useCallback(async (productId, comment) => {
...
const translations = {
  en: {
    ...
    about: "About",
    contact: "Contact Us",
    hero_title: "Your Ultimate Sports Store",
    hero_sub: "Premium gear for every sport. Top brands, unbeatable prices.",
    shop_now: "Shop Now",
    view_all: "View All",
    ...
    blog_title: "Sports Blog",
    blog_sub: "Tips, news & training guides",
    read_more: "Read More",
    about_title: "About SportZone",
    about_sub:
    ...
    chat_title: "Live Chat Support",
    chat_placeholder: "Type a message...",
    send: "Send",
    success_title: "Order Placed Successfully!",
    success_msg: "Thank you for your order. We will contact you soon.",
    go_home: "Back to Home",
    order_id: "Order ID",
    est_delivery: "Estimated delivery: 2-4 business days",
  ...
  ar: {
    ...
    about: "عن المتجر",
    contact: "تواصل معنا",
    hero_title: "متجرك الرياضي الأول",
    hero_sub: "أفضل المعدات لكل الرياضات. أشهر الماركات وأسعار لا تُقاوم.",
    shop_now: "تسوق الآن",
    view_all: "عرض الكل",
    ...
    pay_paypal: "باي بال / فوري",
    pay_cod: "الدفع عند الاستلام",
    card_num: "رقم البطاقة",
    expiry: "تاريخ الانتهاء",
    cvv: "CVV",
    place_order: "تأكيد الطلب",
    pay_when_delivered: "الدفع عند وصول الطلب",
    blog_title: "مدونة سبورت زون",
    blog_sub: "نصائح، أخبار وأدلة تدريبية",
    read_more: "اقرأ المزيد",
    about_title: "عن SportZone",
    about_sub:
      "نحن شغوفون بالرياضة وملتزمون بتقديم أفضل المعدات لكل الرياضيين.",
    our_team: "فريقنا",
    our_values: "قيمنا",
    ...
    success_msg: "شكراً لطلبك. سنتواصل معك قريباً.",
    go_home: "العودة للرئيسية",
    order_id: "رقم الطلب",
    est_delivery: "التوصيل المتوقع: 2-4 أيام عمل",
